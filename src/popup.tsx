...
import restoneLogo from "../assets/RESTONE_LOGO.svg";
import imgCamera from "./img/jack-qa-assets-icons-png-svg/png/camera.png";
import imgVideo from "./img/jack-qa-assets-icons-png-svg/png/video.png";
import imgActions from "./img/jack-qa-assets-icons-png-svg/png/actions.png";
import imgCursor from "./img/jack-qa-assets-icons-png-svg/png/selector.png";
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <img src={restoneLogo} alt="Redstone QA" style={{ width: 132, height: 22, objectFit: "contain", flexShrink: 0 }} />
          <span style={{ color: "#c2c2c2", fontSize: 22, lineHeight: 1, fontWeight: 700, letterSpacing: "0.02em" }}>QA</span>
        </div>
        {siteLabel && (
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
        <ActionCard
          icon={<img src={imgCamera} alt="" style={{ width: 44, height: 44, objectFit: "contain", borderRadius: 10 }} />}
          label={t("screenshot")}
          onClick={handleScreenshot}
        />
        <ActionCard
          icon={<img src={imgVideo} alt="" style={{ width: 44, height: 44, objectFit: "contain", borderRadius: 10 }} />}
        ...
        />
        <ActionCard
          icon={<img src={imgActions} alt="" style={{ width: 44, height: 44, objectFit: "contain", borderRadius: 10 }} />}
          label={recording ? t("stopRecording") : t("recordActions")}
          onClick={toggleRecording}
          danger={recording}
        />
        <ActionCard
          icon={<img src={imgCursor} alt="" style={{ width: 44, height: 44, objectFit: "contain", borderRadius: 10 }} />}
